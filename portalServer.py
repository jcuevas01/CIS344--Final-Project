    ...
    def do_POST(self):
        ...
        try:
            if self.path == '/addStudent':
                ...
                '''
                self.database.addStudent(str(student_name), str(student_courseid),str(student_grade))
                self.database.addCourse(str(course_courseName))
    ...
    def do_GET(self):
        try:
            ...
            if self.path == '/addCourse':
                ...
                self.wfile.write(b'<label for="courseName">Course Name:</label>\
            ...
            if self.path =='/searchStudent':
                ...
                self.wfile.write(b'<label for="searchStudent">Student ID:</label>\
